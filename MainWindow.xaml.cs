        ...
        public MainWindow()
        {
            ...
            var vm = new CheckedComboBoxViewModel<object>
            {
                Items = new List<CheckedComboBoxItem<object>>
                {
                    ...
                    new CheckedComboBoxItem<object>(null) { Name="4", IsSelected = false },
                    new CheckedComboBoxItem<object>(null) { Name="5", IsSelected = false },
                    new CheckedComboBoxItem<object>(null) { Name="6", IsSelected = false },
                    ...
                    new CheckedComboBoxItem<object>(null) { Name="3", IsSelected = false },
                    new CheckedComboBoxItem<object>(null) { Name="3", IsSelected = false },
                    new CheckedComboBoxItem<object>(null) { Name="44", IsSelected = false },
                    new CheckedComboBoxItem<object>(null) { Name="3", IsSelected = false },
                    new CheckedComboBoxItem<object>(null) { Name="3", IsSelected = false },
                    new CheckedComboBoxItem<object>(null) { Name="3", IsSelected = false },
